...
croot
cd vendor/nxp/opensource/commonsys/packages/apps/Nfc
...
croot
cd package/providers/MediaProvider
...
croot
sed -i 's/8.20/8.28/' vendor/lineage/config/version.mk
echo Asb added sucesfully
